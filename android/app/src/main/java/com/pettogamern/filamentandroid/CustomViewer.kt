...
class CustomViewer {
    ...
    fun setSurfaceView(mSurfaceView: SurfaceView) {
        //mSurfaceView.setBackgroundColor(Color.GREEN)
    ...
    fun loadIndirectLight(context: Context, ibl: String) {
        ...
        var buffer = readAsset(context, "venetian_crossroads_2k/${ibl}_ibl.ktx")
    ...
    fun loadEnviroment(context: Context, ibl: String) {
        ...
        var buffer = readAsset(context, "venetian_crossroads_2k/${ibl}_skybox.ktx")
